package com.fabler.jetflix.ui.theme
...
private val LightColorPalette = JetFlixColorPalette(
  brand = White,
  accent = DeepGreen,
...
object JetFlixTheme {
  val colors: JetFlixColorPalette
    @Composable
...
class JetFlixColorPalette(
  ...
  fun update(other: JetFlixColorPalette) {
...
@Composable
fun ProvideJetFlixColors(
  colors: JetFlixColorPalette,
  content: @Composable () -> Unit
) {
...
private val LocalAppColor = staticCompositionLocalOf<JetFlixColorPalette> {
  error("No AppColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [JetFlixTheme.colors].
 */
fun debugColors(
  darkTheme: Boolean,
