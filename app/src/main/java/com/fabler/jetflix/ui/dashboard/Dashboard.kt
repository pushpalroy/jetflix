...
enum class DashboardSections(
  ...
  HOME(R.string.dashboard_home, Icons.Outlined.Home, "dashboard/home"),
  PLAY_SOMETHING(R.string.dashboard_play, Icons.Outlined.Shuffle, "dashboard/play"),
  COMING_SOON(R.string.dashboard_coming_soon, Icons.Outlined.PlayCircle, "dashboard/coming_soon"),
  DOWNLOADS(R.string.dashboard_downloads, Icons.Outlined.Downloading, "dashboard/downloads")
}
...
fun JetFlixBottomBar(
  ...
  color: Color = JetFlixTheme.colors.iconPrimary,
